...
*ȷ������RTF�ļ���·�������;
ods rtf file="&root.\&_mode.\Output\RTF\&_Date.\2020-689-00CH3_PatientProfile_NoChange_&subj..rtf"  style=styles.custom; /**/
...
*ȷ������RTF�ļ���·�������;
ods pdf file="&root.\&_mode.\Output\PDF\&_Date.\2020-689-00CH3_PatientProfile_NoChange_&subj..pdf"  style=styles.custom; /**/
...
%macro loop_nchg;
proc sql noprint;
select distinct subject into: subjlist2 separated by " "
from nochg;
quit;

%let subjcount2=%sysfunc(countw(&subjlist2,%str( ))); 
%do i=1 %to &subjcount2;

%let subjcurrent2=%scan(&subjlist2,&i,%str( ));
%put &subjcount2.;
%put &subjcurrent2.;
%reportrtf(subj=&&subjcurrent2);
%reportpdf(subj=&&subjcurrent2);
