*Run the following 4 lines for cleaning:;
dm 'out;clear;';
dm 'log;clear;';
dm 'lst;clear;';
...
%let OUTpath=C:\Users\yuanyuanp\Desktop\OUT;
...
if (uk2 ^='UK' and uk2 ^='') and (uk3 ^= 'UK' and uk3 ^='') then do;
	...
	if nall>ncut then flag='Date of data is after the Cut off date.';
end;
if uk2='UK' and uk3='UK' or uk2='' and uk3='' then do;
	if nuk1>ncutyr then flag='Month and Day are unknown, Year of data is after the Cut off year.';else flag='';
end;
if uk2 ^='' and uk2 ^='UK' and (uk3='' or uk3='UK') then do;
	if nuk1>ncutyr or nuk1=ncutyr and nuk2>ncutmos then flag='Day is unknown, Year or Month is after the Cut off Year or Month.';else flag='';
end;
